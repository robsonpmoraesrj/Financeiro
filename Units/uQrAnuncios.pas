...
type
  TqrRelAnuncios = class(TQuickRep)
    QRBand1: TQRBand;
    QRImage1: TQRImage;
    QRLabel1: TQRLabel;
    QRLabel2: TQRLabel;
...
procedure TqrRelAnuncios.QRBand2AfterPrint(Sender: TQRCustomBand;
  BandPrinted: Boolean);
begin
...
procedure TqrRelAnuncios.QRBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TqrRelAnuncios.QRBand4AfterPrint(Sender: TQRCustomBand;
  BandPrinted: Boolean);
begin
  tot_pct_investido := 0;
end;

procedure TqrRelAnuncios.QRBand4BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TqrRelAnuncios.QuickRepBeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
