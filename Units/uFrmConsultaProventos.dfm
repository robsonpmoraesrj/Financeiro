object frmConsultaProventos: TfrmConsultaProventos
  Left = 2
  Top = 156
  Width = 1531
  Height = 648
  Caption = 'Consulta Proventos Anuais - v.01'
  Color = clBtnFace
  ...
  object dbgConsulta: TDBGrid
    ...
    Width = 1513
    Height = 449
    DataSource = DMPrincipal.dsConProventosAno
  ...
  object gbStatus: TGroupBox
    ...
    object chkBFIIs: TCheckBox
      ...
      Enabled = False
      TabOrder = 0
      OnClick = chkBFIIsClick
    end
    object chkBAcoes: TCheckBox
      Left = 166
      Top = 29
      Width = 72
      Height = 17
      ...
      Enabled = False
      TabOrder = 1
      OnClick = chkBAcoesClick
    end
    object chkBRF: TCheckBox
      Left = 517
      Top = 29
      Width = 77
      Height = 17
    ...
    object chkBReits: TCheckBox
      ...
      Enabled = False
      TabOrder = 4
      OnClick = chkBReitsClick
    end
    object chkBETFs: TCheckBox
      Left = 335
      Top = 29
      Width = 72
      Height = 17
      ...
      Enabled = False
      TabOrder = 5
      OnClick = chkBETFsClick
    end
    object chkBStocks: TCheckBox
      Left = 426
      Top = 29
      Width = 72
      Height = 17
