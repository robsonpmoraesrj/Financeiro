...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        // alterado para utilizar o formato brasileiro e não mais o americano - RMoraes - 02/03/2023...
        ...
        dDataAberturaI := copy(mskeAberturaI.Text,4,7) + '/' + copy(mskeAberturaI.Text,1,2);
        dDataAberturaF := copy(mskeAberturaF.Text,4,7) + '/' + copy(mskeAberturaF.Text,1,2);
        DMPrincipal.ADOQPerformace.SQL.Add('and substring(convert(varchar,(tf.competencia),111),1,7) between ' + quotedstr(dDataAberturaI) +  ' and ' + quotedstr(dDataAberturaF));
      end;
    end
    else
    begin
      ...
      DMPrincipal.ADOQPerformace.SQL.Add('and substring(convert(varchar,(tf.competencia),111),1,7) >= ' + quotedstr(dDataAberturaI));
    end;
  end
  else
  begin
    ...
    begin
      ...
      DMPrincipal.ADOQPerformace.SQL.Add('and substring(convert(varchar,(tf.competencia),111),1,7) <= ' + quotedstr(dDataAberturaF));
    end;
  end;
