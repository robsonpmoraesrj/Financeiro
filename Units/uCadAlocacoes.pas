...
begin
  ...
  begin
    ...
    if not Result then
    begin
      ShowMessage('Data de Abertura não é uma data válida!');
      exit;
      dbeInicio.SetFocus;
    end
    else
  ...
  begin
    ...
    if not Result then
    begin
      ShowMessage('Data de Vencimento não é uma data válida!');
      exit;
      dbeVencto.SetFocus;
    end
    else
