object frmCadInvestidores: TfrmCadInvestidores
  Left = 215
  Top = 221
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Cadastro de Investidores'
  ClientHeight = 334
  ClientWidth = 499
  Color = clBtnFace
  ...
  object GroupBox1: TGroupBox
    ...
    object dbnInvestidor: TDBNavigator
      Left = 8
      Top = 24
      Width = 224
      Height = 25
      DataSource = DMPrincipal.DSInvestidor
      VisibleButtons = [nbFirst, nbPrior, nbNext, nbLast]
      TabOrder = 2
    end
  end
  object dbgInvestidor: TDBGrid
    Left = 8
    Top = 120
    Width = 481
    Height = 120
